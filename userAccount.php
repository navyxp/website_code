...
if(isset($_POST['signupSubmit']))
{
    ...
    if(!empty($_POST['first_name']) && !empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['confirm_password']))
    {
        ...
        else
        {
            ...
            $prevCon['where'] = array('first_name'=>$_POST['first_name']);
            ...
            {
                $sessData['status']['type'] = 'error';
                $sessData['status']['msg'] = 'Username already exists, please choose another Username.';
           }
    ...
    $redirectURL = ($sessData['status']['type'] == 'success')?$url:'registration.php';
